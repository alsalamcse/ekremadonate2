...
import com.example.owner.ekremadonate2.MyTask;
...
public class MyTasksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(android.support.v4.R.taskfragment_item_list, container, false);
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new MyItemlistRecyclerViewAdapter(readTasks(), mListener));
        }
        return view;
    }
